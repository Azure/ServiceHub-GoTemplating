...
func init() {
	...
	generateCmd.Flags().StringVar(&options.generationType, "generationType", "resource", "Type of folder you want to generate. Must be one of \"pipeline\", \"service\", or \"resource\", or \"globalResource\".")
...
func generate(cmd *cobra.Command, args []string) error {
	...
	allInput.ServiceDirectoryNameToRunPipeline = map[string]bool{}
	...
	for _, serviceConfigFile := range serviceConfigFiles {
		...
		_, exists := allInput.ServiceDirectoryNameToRunPipeline[allInput.ServiceInput.DirectoryName]
		if exists {
		...
		allInput.ServiceDirectoryNameToRunPipeline[allInput.ServiceInput.DirectoryName] = allInput.ServiceInput.RunPipeline
