...
func init() {
	...
	var useRemoteProto bool
	var RemoteProtoConfig populatemethods.RemoteProtoConfig
	...
	var populateMethodFilesCmd = &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			err := populatemethods.PopulateAllMethodFiles(svcDirName, protoFilePath, deleteGarbageFiles, useRemoteProto, RemoteProtoConfig)
			return err
		},
	}
	...
	populateMethodFilesCmd.Flags().BoolVar(&useRemoteProto, "useRemoteProto", false, "Whether or not to use a remote proto file")
	populateMethodFilesCmd.Flags().StringVar(&RemoteProtoConfig.Owner, "owner", "", "The owner of the remote repo") // i.e. Azure if the repository URL is https://github.com/Azure/OperationContainer
	populateMethodFilesCmd.Flags().StringVar(&RemoteProtoConfig.Repo, "repo", "", "The name of the remote repo")    // i.e. OperationContainer if the repository URL is https://github.com/Azure/OperationContainer
